package be.one.test.testbench.elements.components;

import com.vaadin.flow.component.tabs.testbench.TabElement;
import com.vaadin.flow.component.tabs.testbench.TabsElement;
import be.one.test.testbench.elements.ui.DashboardViewElement;
import be.one.test.testbench.elements.ui.LoginViewElement;
import be.one.test.testbench.elements.ui.StorefrontViewElement;
import be.one.test.testbench.elements.ui.ProductsViewElement;
