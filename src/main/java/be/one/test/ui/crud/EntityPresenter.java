...
import be.one.test.app.HasLogger;
import be.one.test.backend.data.entity.AbstractEntity;
import be.one.test.backend.data.entity.User;
import be.one.test.backend.data.entity.util.EntityUtil;
import be.one.test.backend.service.CrudService;
import be.one.test.backend.service.UserFriendlyDataException;
import be.one.test.ui.utils.messages.CrudErrorMessage;
import be.one.test.ui.utils.messages.Message;
import be.one.test.ui.views.EntityView;
