...
import static be.one.test.ui.dataproviders.DataProviderUtil.createItemLabelGenerator;
...
import be.one.test.backend.data.OrderState;
import be.one.test.backend.data.entity.Order;
import be.one.test.backend.data.entity.PickupLocation;
import be.one.test.backend.data.entity.User;
import be.one.test.ui.dataproviders.DataProviderUtil;
import be.one.test.ui.dataproviders.PickupLocationDataProvider;
import be.one.test.ui.dataproviders.ProductDataProvider;
...
import be.one.test.ui.views.storefront.events.ReviewEvent;
import be.one.test.ui.views.storefront.events.ValueChangeEvent;
