package be.one.test.ui.views.storefront;

import static be.one.test.ui.utils.FormattingUtils.HOUR_FORMATTER;
import static be.one.test.ui.utils.FormattingUtils.MONTH_AND_DAY_FORMATTER;
import static be.one.test.ui.utils.FormattingUtils.SHORT_DAY_FORMATTER;
import static be.one.test.ui.utils.FormattingUtils.WEEKDAY_FULLNAME_FORMATTER;
import static be.one.test.ui.utils.FormattingUtils.WEEK_OF_YEAR_FIELD;
...
import be.one.test.backend.data.entity.OrderItem;
import be.one.test.backend.data.entity.OrderSummary;
